...
// se borro este componente porque se decidió mostrar proyectos reales en la sección "Sobre mí" a través de GitHub Stats, e
// n lugar de una lista genérica de repositorios. Esto permite destacar proyectos específicos con métricas reales de GitHub,
// mostrando actividad y contribuciones recientes, lo que da una imagen más auténtica y actualizada del trabajo del desarrollador.
